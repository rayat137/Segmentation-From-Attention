...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return  attn_output, attn_weights, past_key_value   #attn_output, attn_scores, past_key_value 
...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ##NOTE: ADD CLAMP TO GET RID OF NAN
        # if self.clamp_before_norm:
        #     clamp_value = 5e2  # or 1e5 if 1e4 causes degradation
